  ...
  return (
    <WorkerLayout>
      <div className="mb-10 md:mb-16 space-y-4">
        ...
        <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight text-white leading-none">Profile<span className="text-primary">.</span></h1>
      ...
      <div className="grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8 md:space-y-10">
          <div className="bg-white/[0.02] border border-white/[0.05] rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-10 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center text-center space-y-6 md:space-y-8 relative z-10">
              <div className="relative group/avatar">
                ...
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center text-white font-bold text-4xl md:text-5xl shadow-2xl shadow-primary/20 relative z-10">
                  {user?.username?.charAt(0) || user?.name?.charAt(0) || "W"}
                </div>
              </div>

              <div className="space-y-3">
                <h2 className="text-2xl md:text-3xl font-display font-bold text-white flex items-center justify-center gap-3">
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6">
            <Button 
              variant="outline" 
              className="flex-1 h-16 md:h-20 rounded-[1.5rem] md:rounded-[2rem] border-white/[0.08] bg-white/[0.02] hover:bg-destructive/10 hover:text-destructive hover:border-destructive/20 font-bold text-[10px] md:text-[11px] uppercase tracking-[0.2em] group"
