  ...
  return (
    <WorkerLayout>
      <div className="mb-10 md:mb-16 space-y-4">
        ...
        <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight text-foreground leading-none">Wallet<span className="text-primary">.</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-16 overflow-hidden">
              ...
              <div className="relative z-10 space-y-8 md:space-y-12">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      <h2 className="text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-foreground">Available Balance</h2>
                  ...
                  <div className="hidden sm:block">
                    <Badge variant="outline" className="bg-muted/30 border-border text-foreground px-4 py-2 text-[10px] font-bold uppercase tracking-widest rounded-full">
                      USD / FIAT
                    </Badge>
                  </div>
                </div>
                ...
                <div className="flex items-baseline gap-2 md:gap-4">
                  ...
                  <div className="text-5xl md:text-9xl font-display font-bold text-foreground tracking-tighter">
                ...
                <div className="grid grid-cols-2 gap-6 md:gap-12 pt-8 md:pt-12 border-t border-border">
                  <div className="space-y-2">
                    ...
                    <div className="text-xl md:text-3xl font-display font-bold text-foreground">${(user?.earnings || 0).toFixed(2)}</div>
                  </div>
                  <div className="space-y-2">
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-display font-bold text-foreground tracking-tight">Recent Transactions</h2>
              <div className="text-[9px] font-mono font-bold text-muted-foreground/40 uppercase tracking-widest">
                Node_History // v1.0.4
              </div>
            </div>
            
            <div className="rounded-[2.5rem] border border-border glass-card overflow-hidden">
              <div className="divide-y divide-white/[0.05]">
                {withdrawals.length === 0 ? (
                  <div className="p-20 text-center space-y-4">
                    <div className="w-16 h-16 rounded-full bg-card border border-border flex items-center justify-center mx-auto opacity-20">
                  ...
                  withdrawals.map((w) => (
                    <div key={w.id} className="p-6 md:p-8 flex items-center justify-between hover:bg-card transition-all duration-300 group">
                      <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <div className="space-y-1">
                          <div className="text-base md:text-lg font-bold text-foreground capitalize">{w.method} Payout</div>
                      ...
                      <div className="text-right space-y-1 md:space-y-2">
                        <div className="text-xl md:text-2xl font-display font-bold text-foreground">-${w.amount.toFixed(2)}</div>
        ...
        <div className="lg:col-span-4">
          {/* Withdrawal Form */}
          <div className="bg-card border border-border rounded-[2.5rem] p-10 sticky top-12 shadow-2xl space-y-10">
            <div className="space-y-2">
              <h2 className="text-2xl font-display font-bold text-foreground tracking-tight">Request Payout</h2>
            ...
            <form onSubmit={handleWithdraw} className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <Select value={method} onValueChange={setMethod}>
                  <SelectTrigger className="h-14 bg-card border-border focus:border-primary rounded-2xl px-6 text-sm">
