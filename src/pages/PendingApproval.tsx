      ...
      >
        ...
        <div className="relative z-10 mb-12">
          <div className="flex justify-between items-end mb-4">
            <div>
              <h1 className="text-3xl md:text-4xl font-display font-medium text-foreground mb-2">Verification</h1>
          ...
          {activeTab === "status" ? (
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted/10 border border-border">
            ...
            >
              ...
              {missions.map((mission) => (
                <div 
                  key={mission.id}
                  className={`p-5 rounded-3xl border transition-all ${mission.completed ? 'bg-green-500/5 border-green-500/20' : 'bg-muted/10 border-border hover:border-border'}`}
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${mission.completed ? 'bg-green-500/10 text-green-500' : 'bg-muted text-zinc-500'}`}>
